...
@property (strong,   readwrite) NSData *                      responseContent;

// private properties

@property (strong,   readwrite) NSHTTPURLResponse *           response;
@property (strong, readwrite) QHTTPOperation *              networkOperation;
@property (strong, readwrite) NSTimer *                     retryTimer;
@property (strong, readwrite) QReachabilityOperation *      reachabilityOperation;
